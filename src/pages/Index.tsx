    ...
    <>
      <div className="min-h-screen bg-gradient-to-br from-red-50 via-yellow-50 to-red-100">
        ...
        <div className="bg-gradient-to-r from-red-600 via-red-700 to-red-800 text-white py-8 shadow-2xl relative overflow-hidden">
          <div className="absolute inset-0 opacity-20 bg-gradient-to-br from-white/10 to-transparent animate-pulse"></div>
        ...
        {/* Sticky Footer */}
        <footer className="bg-gradient-to-r from-red-600 to-red-700 text-white py-6 mt-12 sticky bottom-0">
